...
export class FilmsPage {
    ...
    constructor(
        ...
        // this.films = this.getData();     // Data offline
        // this.hideLoading();
    }
    ...
    private getFilms() {
        this.swapi.getFilms().then(
            data => {
                this.metadata.count = data['count'];
                this.metadata.next = data['next'];
                this.films = this.films.concat(data['data']);
                this.sort(false);
    ...
    listActors(item: any) {
        this.navCtrl.push(ActorsPage, { film: item });
    }
    ...
    loadMore(infiniteScroll) {
        ...
        if (this.films.length >= this.metadata.count) {
    ...
    private getData() {
        ...
        return arr.map(elem => new Film(elem));
    }
